...
"""
    ...
    A Datum has the following attributes:
        ...
        * _key:       A string (or other hashable object) representing
                      ...
                      Is used to detect redundant tasks
...
class Datum:
    ...
    def __init__(self, parent_uid, **kwargs):
        ...
        self.content = self.generate_content(**kwargs)
    ...
    def generate_content(self, **kwargs):
        raise NotImplementedError(f"Need to implement `generate_content` for {type(self)}")
